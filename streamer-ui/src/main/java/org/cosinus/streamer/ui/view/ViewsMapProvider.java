 ...
 */
@Component
public class ViewsMapProvider extends JsonFileConverter<ViewsMap> {

    private static final String VIEWS_FILE_NAME = "views.json";

    protected ViewsMapProvider(ObjectMapper objectMapper, Set<ResourceResolver> resourceResolvers) {
        super(objectMapper, ViewsMap.class, resourceResolvers);
    }

    public Optional<ViewsMap> getViewsMap() {
        try {
            return convert(VIEWS_FILE_NAME);
