...
public class DetailsStreamerEditor<T extends Streamable> implements StreamerEditor<T>, SaveWorkerModel<T> {

    private final DetailsView<T> view;

    private final DetailEditor<T> detailEditor;
    ...
    public DetailsStreamerEditor(final DetailsView<T> view) {
        this.view = view;
        this.detailEditor = new DetailEditor<>(this, 0);
    }
    ...
    public void loadAndShow(final T itemToBeEdited) {
        ...
        Rectangle detailRectangle = view.getCurrentCellRectangle();
    ...
    public void setVisible(boolean visible) {
        detailEditor.setVisible(visible);
        if (!visible) {
