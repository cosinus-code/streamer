...
public class HeaderCellBorder extends LineBorder {
    ...
    public HeaderCellBorder(Color color) {
        this(color, 1, false);
    }

    public HeaderCellBorder(Color color, int thickness) {
        this(color, thickness, false);
    }

    public HeaderCellBorder(Color color, int thickness, boolean roundedCorners) {
        super(color, thickness, roundedCorners);
    }

    public HeaderCellBorder(Color color, int top, int left, int bottom, int right) {
        this(color, 1, top, left, bottom, right);
    }

    public HeaderCellBorder(Color color, int thickness, int top, int left, int bottom, int right) {
